  ...
  return (
    <div className="flex items-center justify-center bg-background ">
      <Card className="w-full max-w-lg mt-10 mx-2">
        <CardHeader>
          <CardTitle className="gradient-title text-4xl mb-4">Complete Your Profile</CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            >
              <SelectTrigger className="w-[475px]"  id="industry">
            ...
            {watchIndustry && (<div className="space-y-4">
              <Label htmlFor="subIndustry">Specialization</Label>
            <Select 
              onValueChange={(value) => setValue("subIndustry", value)}
            >
              <SelectTrigger className="w-[475px]" id="subIndustry">
            ...
            <Button type="submit" className="w-full space-y-4 mt-4" disabled={updateLoading}>
              {
                updateLoading ? (
                  <>
